...
When the collecting node evaluates the resource, the function will evaulate in the context of the collecting node, where it will compare the $timestamp parameter to the tim now.
